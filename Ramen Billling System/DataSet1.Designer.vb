...
Partial Public Class DataSet1
    ...
    Partial Public Class salesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddsalesRow(ByVal itemid As Integer, ByVal orderno As Integer, ByVal itemname As String, ByVal _date As Date, ByVal price As Integer, ByVal qty As Integer) As salesRow
            Dim rowsalesRow As salesRow = CType(Me.NewRow,salesRow)
            Dim columnValuesArray() As Object = New Object() {itemid, orderno, itemname, _date, price, qty}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function FindByorderno(ByVal orderno As Integer) As salesRow
            Return CType(Me.Rows.Find(New Object() {orderno}),salesRow)
        End Function
    ...
    Partial Public Class salesRow
        ...
        Public Property itemid() As Integer
            Get
                Return CType(Me(Me.tablesales.itemidColumn),Integer)
            End Get
            Set
                Me(Me.tablesales.itemidColumn) = value
            End Set
        End Property
        ...
        Public Property orderno() As Integer
            Get
                Return CType(Me(Me.tablesales.ordernoColumn),Integer)
            End Get
            Set
                Me(Me.tablesales.ordernoColumn) = value
            End Set
        End Property
...
Namespace DataSet1TableAdapters
    ...
    Partial Public Class salesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [sales] WHERE (([itemid] = @Original_itemid) AND ([orderno] = @Origin"& _ 
                "al_orderno) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_da"& _ 
                "te)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [sales] ([itemid], [orderno], [itemname], [date], [price], [qty]) VAL"& _ 
                "UES (@itemid, @orderno, @itemname, @date, @price, @qty);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT itemid, orderno"& _ 
                ", itemname, date, price, qty FROM sales WHERE (orderno = @orderno)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [sales] SET [itemid] = @itemid, [orderno] = @orderno, [itemname] = @itemna"& _ 
                "me, [date] = @date, [price] = @price, [qty] = @qty WHERE (([itemid] = @Original_"& _ 
                "itemid) AND ([orderno] = @Original_orderno) AND ((@IsNull_date = 1 AND [date] IS"& _ 
                " NULL) OR ([date] = @Original_date)) AND ((@IsNull_price = 1 AND [price] IS NULL"& _ 
                ") OR ([price] = @Original_price)) AND ((@IsNull_qty = 1 AND [qty] IS NULL) OR (["& _ 
                "qty] = @Original_qty)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT itemid, orderno, itemname, date, price, qty FRO"& _ 
                "M sales WHERE (orderno = @orderno)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Ramen_Billling_System.My.MySettings.Default.Database1ConnectionString1
        End Sub
        ...
        Public Overloads Overridable Function Delete(ByVal Original_itemid As Integer, ByVal Original_orderno As Integer, ByVal Original_date As Global.System.Nullable(Of Date), ByVal Original_price As Global.System.Nullable(Of Integer), ByVal Original_qty As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_itemid,Integer)
            Me.Adapter.DeleteCommand.Parameters(1).Value = CType(Original_orderno,Integer)
            ...
            If (Original_qty.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(7).Value = CType(Original_qty.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal itemid As Integer, ByVal orderno As Integer, ByVal itemname As String, ByVal _date As Global.System.Nullable(Of Date), ByVal price As Global.System.Nullable(Of Integer), ByVal qty As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.InsertCommand.Parameters(0).Value = CType(itemid,Integer)
            Me.Adapter.InsertCommand.Parameters(1).Value = CType(orderno,Integer)
        ...
        Public Overloads Overridable Function Update(ByVal itemid As Integer, ByVal orderno As Integer, ByVal itemname As String, ByVal _date As Global.System.Nullable(Of Date), ByVal price As Global.System.Nullable(Of Integer), ByVal qty As Global.System.Nullable(Of Integer), ByVal Original_itemid As Integer, ByVal Original_orderno As Integer, ByVal Original_date As Global.System.Nullable(Of Date), ByVal Original_price As Global.System.Nullable(Of Integer), ByVal Original_qty As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.UpdateCommand.Parameters(0).Value = CType(itemid,Integer)
            Me.Adapter.UpdateCommand.Parameters(1).Value = CType(orderno,Integer)
            If (itemname Is Nothing) Then
            ...
            Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_orderno,Integer)
            If (Original_date.HasValue = true) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal itemid As Integer, ByVal itemname As String, ByVal _date As Global.System.Nullable(Of Date), ByVal price As Global.System.Nullable(Of Integer), ByVal qty As Global.System.Nullable(Of Integer), ByVal Original_itemid As Integer, ByVal Original_orderno As Integer, ByVal Original_date As Global.System.Nullable(Of Date), ByVal Original_price As Global.System.Nullable(Of Integer), ByVal Original_qty As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(itemid, Original_orderno, itemname, _date, price, qty, Original_itemid, Original_orderno, Original_date, Original_price, Original_qty)
        End Function
    End Class
